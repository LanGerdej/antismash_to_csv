...
BGC = ["2dos", "acyl_amino_acids", "aminocoumarin", "aminopolycarboxylic-acid", "amglyccycl", 
    "arylpolyene", "betalactone", "blactam", "bottromycin", "butyrolactone", "CDPS", 
    "crocagin", "cyanobactin", "cyclic-lactone-autoinducer", "ectoine", "epipeptide", 
    "fatty_acid", "furan", "fungal-RiPP", "fungal-RiPP-like", "glycocin", "guanidinotides", 
    "halogenated", "hglE-KS", "hserlactone", "indole", "LAP", "ladderane", "lanthipeptide class I", 
    "lanthipeptide class II", "lanthipeptide class III", "lanthipeptide class IV", 
    "lanthipeptide class V", "lassopeptide", "linaridin", "lipolanthine", "melanin", 
    "methanobactin", "microviridin", "mycosporine-like", "NAGGN", "NAPAA", "NRPS", "NRPS-like", 
    "NRP-metallophore", "NRPS-independent-siderophore", "nucleoside", "oligosaccharide", 
    "opine-like-metallophore", "other", "PBDE", "phenazine", "phosphoglycolipid", 
    "phosphonate", "phosphonate-like", "PKS-like", "PpyS-KS", "prodigiosin", "proteusin", 
    "PUFA", "pyrrolidine", "ranthipeptide", "RaS-RiPP", "RCDPS", "redox-cofactor", "resorcinol", 
    "RiPP-like", "RRE-containing", "saccharide", "sactipeptide", "spliceotide", "T1PKS", 
    "T2PKS", "T3PKS", "terpene", "thioamitides", "thioamide-NRP", "thiopeptide", "transAT-PKS", 
    "transAT-PKS-like", "tropodithietic-acid", "siderophore", "bacteriocin", "fused", "head_to_tail", 
    "lanthidin", "lanthipeptide", "TfuA-related", "otherks", "microcin", "cf_saccharide", 
    "cf_fatty_acid", "cf_putative"]
